        ...
        <section id="solucoes" className="relative bg-[#050505] py-40 overflow-hidden">
                                ...
                                <div className="relative bg-white/[0.03] backdrop-blur-3xl border border-white/10 border-t-white/25 rounded-2xl p-12 shadow-2xl overflow-hidden group-hover:border-white/20 transition-all duration-500">
                                    <div className="flex flex-col">
                                        <div className="flex items-center gap-6 mb-12">
                                            <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-[#FF6A1A] to-[#E54800] flex items-center justify-center shadow-[0_15px_35px_-10px_rgba(255,85,0,0.5),inset_0_1px_1px_rgba(255,255,255,0.4)]">
                                                <Play size={32} className="text-white fill-white ml-1" />
                                            </div>
                                            <div>
                                                <h3 className="text-2xl font-display font-bold text-white uppercase tracking-tight">Mentoria Completa</h3>
                                        ...
                                        <div className="grid grid-cols-2 gap-4 mb-12 py-10 border-y border-white/[0.05]">
                                            ...
                                            <div className="text-center border-l border-white/[0.05]">
                                                <p className="text-4xl font-display font-bold text-white mb-2">R$2M+</p>
                    ...
                    {activeTab === 1 && (
                        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center animate-fade-in-up">
                            ...
                            <div className="relative group">
                                ...
                                <div className="relative bg-white/[0.03] backdrop-blur-3xl border border-white/10 border-t-white/25 rounded-2xl p-12 shadow-2xl">
                                    <div className="absolute top-8 right-8 w-14 h-14 rounded-xl bg-[#FF5500] flex items-center justify-center shadow-[0_10px_25px_-5px_rgba(255,85,0,0.4)]">
                                    ...
                                    <div className="mb-14">
                                        ...
                                        <div className="flex items-baseline gap-3">
                                            <span className="text-7xl font-display font-black text-white tracking-tighter">R$97</span>
                                    ...
                                    <div className="space-y-6 mb-14">
                                        {[
                                            ...
                                            <div key={idx} className="flex items-center gap-4 group/list">
                                                <div className="w-6 h-6 rounded-full bg-[#FF5500]/10 border border-[#FF5500]/20 flex items-center justify-center shrink-0 group-hover/list:border-[#FF5500]/50 transition-all">
                                                    <Check size={14} className="text-[#FF5500]" strokeWidth={3} />
                                                </div>
                                                <span className="text-gray-300 font-sans text-base font-medium opacity-80">{item}</span>
                                            </div>
                                        ))}
                                    </div>
            ...
            <div className="relative mt-40 w-full flex items-center justify-center opacity-10 pointer-events-none">
                ...
                <div className="relative px-8 bg-[#050505] flex items-center gap-3">
                    ...
                    <span className="text-[9px] font-mono text-white/40 tracking-[0.8em] uppercase">Structural Integrity Protocol</span>
                </div>
            </div>
        </section>
    );
