                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-32 items-center">
                    ...
                    <div className="space-y-12 order-1 lg:order-2">
                        <div className="space-y-8 text-center lg:text-left">
                            ...
                            <p className="font-sans text-lg text-gray-500 max-w-xl leading-relaxed mx-auto lg:mx-0">
                            ...
                            <div className="space-y-6 pt-4 flex flex-col items-center lg:items-start font-sans">
                                <div className="flex items-center gap-4">
                                    ...
                                    <span className="text-gray-300 font-bold text-base uppercase tracking-wider">NOTIFICAÇÕES EM TEMPO REAL</span>
                                </div>
                                <div className="flex items-center gap-4">
                                    <div className="w-5 h-5 rounded-sm border-2 border-[#FF5500] flex items-center justify-center text-[#FF5500]">
                                        <Check size={12} strokeWidth={4} />
                                    </div>
                                    <span className="text-gray-300 font-bold text-base uppercase tracking-wider">COMPRAS COM UM TOQUE</span>
                                </div>
                                <div className="flex items-center gap-4">
                                    <div className="w-5 h-5 rounded-sm border-2 border-[#FF5500] flex items-center justify-center text-[#FF5500]">
                                        <Check size={12} strokeWidth={4} />
                        ...
                        {/* Botão Master CTA conforme print */}
